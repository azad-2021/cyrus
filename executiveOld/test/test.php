...
<body> 
  ...
  <div class="container">
    ...
    <div class="modal fade" data-bs-backdrop="static" id="addMultiple" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  if(ZoneCode){
    $.ajax({
      ...
      success:function(result){
        $('#Multimaterial').html(result);
        
      }
    }); 
  }else{
    $('#Multimaterial').html('<option value="">select</option>');
  }
});
