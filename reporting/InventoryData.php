            ...
            <table class="table display text-start align-middle table-bordered border-primary table-hover mb-0">
              <thead>
                <tr class="text-dark">
                  ...
                  <th scope="col" style="min-width:80px">Order ID</th>                       
               ...
               if (mysqli_num_rows($result2)>0)
               {
                ...
                while($row = mysqli_fetch_array($result2)){
                  ...
                  <tr>
                    ...
                    <td><a href=""class="inventory" id="<?php echo $row['OrderID']; ?>" data-bs-toggle="modal" data-bs-target="#InventoryPending"><?php echo $row['OrderID']; ?></a></td>
