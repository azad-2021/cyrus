  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">More jobcard?</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
          ...
          <div class="row">
            <center>
              <div class="col-lg-4" style="margin-top: 20px;">
                <label>More jobcard</label>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="more" value="YES">
                  <label class="form-check-label" for="inlineRadio1">Yes</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="more" value="NO">
