     ...
     <table class="container table table-hover display table-bordered border-primary responsive">
        ...
        <tbody>
          ...
          if (!empty($Data))
          {
            ...
            $query2="SELECT DISTINCT demandextended.ItemID,demandextended.RateID, Description, ItemQty FROM cyrusbackend.demandbase join demandextended on demandbase.OrderID=demandextended.OrderID join cyrusbilling.rates on demandextended.ItemID=rates.ItemID where demandbase.StatusID=3 and rates.ItemID !=1654 and demandbase.OrderID=$OrderID and rates.Zone=$ZoneCode";
