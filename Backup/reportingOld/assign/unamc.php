...
{   
  ...
  //echo $EmployeeID;
  $query="SELECT * FROM cyrusbackend.vallordersd WHERE AssignDate is null and Attended=0 and Discription like '%AMC%' and EmployeeCode=$exEmployeeID";
...
<div class="col-lg-12" style="margin: 12px;">
  <table class="container table table-hover table-bordered border-primary table-responsive">
    ...
    <tbody>
      ...
      {
        $Sn=1;
        $query2="SELECT * FROM cyrusbackend.vallordersd WHERE AssignDate is null and Attended=0 and Discription like '%AMC%' and EmployeeCode=$exEmployeeID";
        ...
        while($row = mysqli_fetch_array($result2)){
          ...
          <tr>
            ...
            <td ALIGN="center">
             <select class="form-control" id="unamc">
