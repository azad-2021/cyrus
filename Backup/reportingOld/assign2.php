      ...
      <div class="col-12">
        ...
        <div id="ref" class="table-responsive">
          ...
          <table id="unassigned" class="table table-hover table-bordered border-primary display  nowrap" style="width:100%">
            <h5 align="center" style="margin:20px;">Unassigned Orders</h5>
            <thead id="unhead">
              <tr>
            ...
            <tbody >
              <?php 
              if ($Type=="Executive") {
                $query="SELECT count(OrderID), `Employee NAME`, EmployeeCode, ExecutiveID FROM cyrusbackend.vallordersd
                left join reporting on vallordersd.EmployeeCode=reporting.EmployeeID
              ...
              while($row=mysqli_fetch_assoc($resultTech)){
                ...
                <tr>
                  ...
                  <td><a class="view_UNO" id="<?php print $EmployeeID; ?>" data-bs-target="#ViewUNO"><?php echo $row["count(OrderID)"]; ?></a></td>              
                </tr>
              <?php } ?>
            </tbody>
          </table>
          ...
          <div id="ref" class="table-responsive">
            <table id="unassigned" class="table table-hover table-bordered border-primary display  nowrap" style="width:100%">
              <h5 align="center" style="margin:20px;">Unassigned Complaints</h5>
              <thead id="unhead">
                <tr>
                  <th>Service Engineer</th>
              ...
              <tbody >
                <?php 
                if ($Type=="Executive") {
                  $query="SELECT count(ComplaintID), `Employee NAME`, EmployeeCode FROM cyrusbackend.vallcomplaintsd
                  WHERE AssignDate is null and Attended=0 group by EmployeeCode order by `Employee NAME`";
                }else{              
                  $query="SELECT EmployeeCode, `Employee Name` FROM cyrusbackend.reporting join employees on reporting.EmployeeID=employees.EmployeeCode WHERE ExecutiveID=$EXEID order by `Employee Name`";
                }
          ...
          <div id="ref" class="table-responsive">
            <table id="unassigned" class="table table-hover table-bordered border-primary display  nowrap" style="width:100%">
              <h5 align="center" style="margin:20px;">Unassigned AMC</h5>
              <thead id="unhead">
                <tr>
                  <th>Service Engineer</th>
                  <th>Unassigned Orders </th>
              ...
              <tbody >
                ...
                <tr>
                  ...
                  <td><a class="view_UAMC" id="<?php print $EmployeeID; ?>" data-bs-target="#ViewUAMC"><?php echo $row["count(OrderID)"];; ?></a></td>             
                </tr>
              <?php } ?>
            </tbody>
          </table>
          ...
          <div id="ref" class="table-responsive">
            <table id="unassigned" class="table table-hover table-bordered border-primary display  nowrap" style="width:100%">
              <h5 align="center" style="margin:20px;">Assigned Orders</h5>
              <thead id="unhead">
                <tr>
                  <th>Service Engineer</th>
              ...
              <tbody >
                <?php 
                if ($Type=="Executive") {
                  $query="SELECT count(OrderID), `Employee NAME`, EmployeeCode FROM cyrusbackend.allorders WHERE AssignDate is not null and Attended=0 and Discription not like '%AMC%' group by EmployeeCode order by `Employee Name`";
                }else{              
                  $query="SELECT EmployeeCode, `Employee Name` FROM cyrusbackend.reporting join employees on reporting.EmployeeID=employees.EmployeeCode WHERE ExecutiveID=$EXEID order by `Employee Name`";
                }
                ...
                <tr>
                  ...
                  <td><a class="view_AO" id="<?php print $EmployeeID; ?>" data-bs-target="#ViewAO"><?php echo $row["count(OrderID)"]; ?></a></td>              
                </tr>
              <?php } ?>
            </tbody>
          </table>
          ...
          <div id="ref" class="table-responsive">
            <table id="unassigned" class="table table-hover table-bordered border-primary display  nowrap" style="width:100%">
              <h5 align="center" style="margin:20px;">Assigned Complaints</h5>
              <thead id="unhead">
                <tr>
                  <th>Service Engineer</th>
              ...
              <tbody >
                <?php 
                if ($Type=="Executive") {
                  $query="SELECT count(ComplaintID), `Employee NAME`, EmployeeCode FROM cyrusbackend.allcomplaint
                  WHERE AssignDate is not null and Attended=0 and EmployeeCode is not null group by EmployeeCode order by `Employee NAME`";
                }else{              
                  $query="SELECT EmployeeCode, `Employee Name` FROM cyrusbackend.reporting join employees on reporting.EmployeeID=employees.EmployeeCode WHERE ExecutiveID=$EXEID order by `Employee Name`";
                }
          ...
          <div id="ref" class="table-responsive">
            <table id="unassigned" class="table table-hover table-bordered border-primary display  nowrap" style="width:100%">
              <h5 align="center" style="margin:20px;">Assigned AMC</h5>
              <thead id="unhead">
                <tr>
                  <th>Service Engineer</th>
                  <th>Assigned AMC</th>
              ...
              <tbody >
                <?php 
                if ($Type=="Executive") {
                  $query="SELECT count(OrderID), `Employee NAME`, EmployeeCode FROM cyrusbackend.allorders WHERE AssignDate is not null and Attended=0 and Discription like '%AMC%' group by EmployeeCode order by `Employee Name`";
                }else{              
                  $query="SELECT EmployeeCode, `Employee Name` FROM cyrusbackend.reporting join employees on reporting.EmployeeID=employees.EmployeeCode WHERE ExecutiveID=$EXEID order by `Employee Name`";
                }
