...
if(isset($_POST['submit'])){
  ...
  if ($link=='CCTV') {
    ...
    $sql2 = "INSERT INTO jobcardcctv (`Card Number`, `CCTVMake`, `CamerNumber`, `RecordingFrom`, `RecordingUpto`, `NoRecording`, `HDDTotal`, `HDDAllocated`, `OpeningCleaning`, `CheckingBNC`, `CheckingPowerSupply`)
    VALUES ('$JOBCARD', '$DVR', '$Camera', '$FDate', '$LDate', '$NoRecording', '$THDD', '$AHDD', '$OpeningCleaning', '$Connector', '$PowerSupply')";
  }
