...
<div class="col-lg-12" style="margin: 12px;">
  <table class="container table table-hover table-bordered border-primary table-responsive">
    ...
    <tbody>
      ...
      {
        $Sn=1;
        $query2="SELECT * FROM vallordersd WHERE AssignDate is null and Attended=0 and Discription like '%AMC%' and vallordersd.EmployeeCode=$exEmployeeID";
  ...
  <div class="col-lg-12" style="margin: 12px;">
    <table class="container table table-hover table-bordered border-primary table-responsive">
      ...
      <tbody>
        ...
        WHERE ControlerID=$EXEID and vallordersd.AssignDate is null and Attended=0 and vallordersd.Discription like '%AMC%' and BankName='$Bank' and ZoneRegionName='$Zone' group by OrderID order by OrderID";
        $result2=mysqli_query($con,$query2);
        while($row = mysqli_fetch_array($result2)){
