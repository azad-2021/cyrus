      ...
      <tbody> 
          ...
          while ($row=mysqli_fetch_array($results,MYSQLI_ASSOC)){ 
              {  
                ...
                $queryBranch ="SELECT * FROM cyrusbackend.branchs join zoneregions on branchs.ZoneRegionCode=zoneregions.ZoneRegionCode join bank on zoneregions.BankCode=bank.BankCode WHERE branchs.BranchCode =$BranchCode";
