...
simprovider.SimType, MobileNumber, SimNo, Operator, simprovider.ReleaseDate as SimReleaseDate, ActivationDate,
...
where orders.Status=3 and orders.Installed=1 order by orders.OrderID";
     ...
     <table class="table table-hover table-bordered border-primary" id="example"> 
      ...
      <tbody> 
        ...
        while ($row=mysqli_fetch_array($results,MYSQLI_ASSOC)){ 
          ...
          }elseif ($row["leftDays"]<=30 and $row["ActivationDate"]!='0000-00-00') {
