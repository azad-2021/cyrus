          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Tota Pending<span>| Orders</span></h5>
                  ...
                  <div class="table-responsive container">
                    <table class="table text-start align-middle table-bordered table-hover mb-0" id="example">
                      ...
                      <tbody>
                        ...
                        join branchdetails on orders.BranchCode=branchdetails.BranchCode
                        WHERE AssignDate is not null and Attended=0 and EmployeeCode=$EXEID";
                        ...
                        print '<td><a id="'.$row['OrderID'].'" data-bs-toggle="modal" data-bs-target="#AddDetails" class="AddDetails">'.$row["OrderID"].'</a></td>';
                        print "<td>".$row["Discription"]."</td>";
                        print "<td>".date("d-m-Y", strtotime($row["DateOfInformation"]))."</td>";
