  ...
  <div class="col-lg-12" style="margin: 12px;">
    <table class="container table table-hover table-bordered border-primary table-responsive">
      ...
      <tbody>
        ...
        WHERE AssignDate is not null and Attended=0 and Discription like '%AMC%' and districts.SubControllerID=$EXEID and EmployeeCode=$EmployeeID";
  ...
  <div class="col-lg-12" style="margin: 12px;">
    <table class="container table table-hover table-bordered border-primary table-responsive">
      ...
      <tbody>
        ...
        WHERE BankCode=$Bank and ZoneRegionCode=$Zone and Discription like '%AMC%' and AssignDate is not null and Attended=0 and districts.SubControllerID=$EXEID";
