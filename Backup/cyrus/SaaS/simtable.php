...
<div class="table-responsive">  
 <table class="table table-hover table-bordered border-primary" id="example3" class="display nowrap"> 
  <thead> 
      <tr>  
...
<div class="table-responsive">  
 <table class="table table-hover table-bordered border-primary" id="example2" class="display nowrap"> 
  <thead> 
      <tr>  
          <th>Mobile No</th>
          <th>Sim Number</th> 
  ...
  <tbody> 
      ...
      $query2 ="SELECT * FROM `simprovider` WHERE `RemarkUpdate` is not null and ActivationDate is not null and IssueDate is null";
