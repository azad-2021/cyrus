      ...
      <form method="POST" action="">
        ...
        if ($Provider2=='Bank' or $Provider2=='No SIM') {
          ...
          <div class="form-row">
            <div class="form-group col-md-3">
              ...
              <input type="number" class="form-control my-select" placeholder="Mobile No" name="Mobile" onkeydown="limit2(this);" onkeyup="limit2(this);" required minlength="10">
            </div>
            <div class="form-group col-md-3">
              <label for="Bank ID">Sim No.</label>
              <input type="number" class="form-control my-select" placeholder="Sim No" name="SimNo" onkeydown="limit1(this);" onkeyup="limit1(this);">
            </div>
            <div class="form-group col-md-3">
        ...
        <center>
          ...
          <div class="form-group col-md-3">
            ...
            <select class="form-control my-select3" name="EmployeeCode" required>
              <option value="">Select</option>
              <?php 
          ...
          <div class="form-group col-md-3">
            ...
            <br>
            <input type="date" name="InstDate" placeholder="dd/mm/yy" class="form-control my-select3" required>
          </div>
          <div class="form-group col-md-3">
            <label for="InstDate">Remark</label>
            <br>
            <input type="text" name="Remark" class="form-control my-select">
          </div>
        </center>
        <br><br>
        <center>
