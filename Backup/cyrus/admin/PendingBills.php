          ...
          <div class="card-body">
            ...
            <div class="table-responsive container">
              <table width="100%" class="table display text-start align-middle table-bordered border-primary table-hover mb-0">
                ...
                <tbody >
                  <?php 
                  $query="SELECT BankName, ZoneRegionName, ZoneRegionCode, BankCode from cyrusbackend.branchdetails WHERE BankName!='Cyrus' group by BankCode, ZoneRegionCode ORDER BY BankName";
                  ...
                  while($row = mysqli_fetch_array($result)){
                    ...
                    WHERE (TotalBilledValue-ReceivedAmount)>1 and Cancelled=0 and BankCode=$BankCode and ZoneRegionCode=$ZoneCode and BillDate>'$ThirtyDays' and BankName!='Cyrus'";
                    ...
                    and BillDate between '$NintyDays' and  '$ThirtyDays' and BankName!='Cyrus'";
                    ...
                    $query1="SELECT sum(TotalBilledValue) as TotalAmount, sum(ReceivedAmount) as ReceiveAMOUNT FROM cyrusbilling.billbook
                    join cyrusbackend.branchdetails on billbook.BranchCode=branchdetails.BranchCode
                    WHERE (TotalBilledValue-ReceivedAmount)>1 and Cancelled=0 and BankCode=$BankCode and ZoneRegionCode=$ZoneCode and BillDate<'$NintyDays' and BankName!='Cyrus'";
                    $result1=mysqli_query($con2,$query1);
