            ...
            <div class="table-responsive container">
              <table width="100%" class="table display text-start align-middle table-bordered border-primary table-hover mb-0">
                ...
                <tbody >
                  ...
                  WHERE districts.SubControllerID=$EXEID and BankName!='Cyrus'
                  ...
                  while($row = mysqli_fetch_array($result)){
                    ...
                    join cyrusbackend.districts on branchdetails.Address3=districts.District
                    join cyrusbackend.`cyrus regions` on districts.RegionCode=`cyrus regions`.RegionCode
                    WHERE (TotalBilledValue-ReceivedAmount)>1 and Cancelled=0 and BankCode=$BankCode and ZoneRegionCode=$ZoneCode and BillDate>'$ThirtyDays' and districts.SubControllerID=$EXEID and BankName!='Cyrus'";
                    ...
                    and BillDate between '$NintyDays' and  '$ThirtyDays' and districts.SubControllerID=$EXEID and BankName!='Cyrus'";
                    ...
                    join cyrusbackend.districts on branchdetails.Address3=districts.District
                    join cyrusbackend.`cyrus regions` on districts.RegionCode=`cyrus regions`.RegionCode
                    WHERE (TotalBilledValue-ReceivedAmount)>1 and Cancelled=0 and BankCode=$BankCode and ZoneRegionCode=$ZoneCode and BillDate<'$NintyDays' and districts.SubControllerID=$EXEID and BankName!='Cyrus'";
                    $result1=mysqli_query($con2,$query1);
