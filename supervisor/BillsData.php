    ...
    <tbody>
     ...
     { 
      ...
      if ($Type=='ControllerID') {
        ...
        WHERE districts.SubControllerID=$EXEID and ZoneRegionCode=$Zone and BankCode=$Bank and Cancelled=0 and (TotalBilledValue-ReceivedAmount)>1 and BankName!='Cyrus' Order By 'BankName'";
      }else{
