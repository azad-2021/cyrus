              ...
              <table width="100%" class="table display text-start align-middle table-bordered border-primary table-hover mb-0">
                ...
                <tbody>
                 ...
                 while($rowE=mysqli_fetch_assoc($resultTech)){
                  ...
                  join `cyrus regions` on districts.RegionCode=`cyrus regions`.RegionCode WHERE AssignDate is null and Attended=0 and EmployeeCode=$EmployeeID and districts.SubControllerID=$EXEID";
                  ...
                  join `cyrus regions` on districts.RegionCode=`cyrus regions`.RegionCode
                  WHERE vallordersd.AssignDate is null and vallordersd.Discription like '%AMC%' and vallordersd.EmployeeCode=$EmployeeID and districts.SubControllerID=$EXEID";
                  ...
                  join districts on vallordersd.Address3=districts.District
                  join `cyrus regions` on districts.RegionCode=`cyrus regions`.RegionCode
                  WHERE AssignDate is null and Discription not like '%AMC%' and vallordersd.EmployeeCode=$EmployeeID and districts.SubControllerID=$EXEID";
          ...
          <div class="card-body">
            ...
            <div class="table-responsive container">
              ...
              <tbody >
                ...
                join `cyrus regions` on districts.RegionCode=`cyrus regions`.RegionCode
                WHERE districts.SubControllerID=$EXEID and Address3 not like 'Reserved'
                ...
                while($rowB=mysqli_fetch_assoc($resultB)){
                  ...
                  join `cyrus regions` on districts.RegionCode=`cyrus regions`.RegionCode
                  where districts.SubControllerID=$EXEID and AssignDate is null and Attended=0 and BankName='$BankName' and ZoneRegionName='$ZoneRegionName'";
                  $result=mysqli_query($con,$query);
                  $row = mysqli_fetch_array($result);
                  ...
                  join `cyrus regions` on districts.RegionCode=`cyrus regions`.RegionCode
                  WHERE districts.SubControllerID=$EXEID and vallordersd.AssignDate is null and vallordersd.Discription like '%AMC%' and BankName='$BankName' and ZoneRegionName='$ZoneRegionName'";
                  $result2=mysqli_query($con,$query2);
                  $row2 = mysqli_fetch_array($result2);
                  ...
                  join districts on vallordersd.EmployeeCode=districts.`Assign To`
                  join `cyrus regions` on districts.RegionCode=`cyrus regions`.RegionCode
                  WHERE districts.SubControllerID=$EXEID and vallordersd.AssignDate is null and vallordersd.Discription not like '%AMC%' and BankName='$BankName' and ZoneRegionName='$ZoneRegionName'";
                  $result3 = mysqli_query($con, $query3);
                  $row3 = mysqli_fetch_array($result3);
