  ...
  <main id="main" class="main">
    ...
    <div class="col-12">
      <div class="card recent-sales overflow-auto">
        ...
        <div class="card-body">
          <h5 class="card-title">Pending Work  <span>| Order-30 days, Complaint-10 days, AMC-60 days</span></h5>
        ...
        <div class="card-body">
          <h5 class="card-title">Completed Work  <span>| Order-30 days, Complaint-10 days, AMC-90 days</span></h5>
            ...
            <table width="100%" class="table display text-start align-middle table-bordered border-primary table-hover mb-0">
              ...
              <tbody>
                ...
                while($rowE=mysqli_fetch_assoc($resultTech)){
                 ...
                 where AttendDate is not null and Attended=1 and datediff(AttendDate, AssignDate)>10 and ControlerID=$EXEID and complaints.EmployeeCode=$EmployeeID and AttendDate>='2022-01-01'";
                 $result=mysqli_query($con,$query);
                 $row = mysqli_fetch_array($result);
                 ...
                 join districts on branchdetails.Address3=districts.District
                 join `cyrus regions` on districts.RegionCode=`cyrus regions`.RegionCode
                 where AttendDate is not null and Attended=1 and datediff(AttendDate, AssignDate)>90 and ControlerID=$EXEID and Discription like '%AMC%'and orders.EmployeeCode=$EmployeeID and AttendDate>='2022-01-01'";
                 $result2=mysqli_query($con,$query2);
                 $row2 = mysqli_fetch_array($result2);
                 $AMC=$row2["count(OrderID)"];
                 ...
                 join districts on branchdetails.Address3=districts.District
                 join `cyrus regions` on districts.RegionCode=`cyrus regions`.RegionCode
                 where AttendDate is not null and Attended=1 and datediff(AttendDate, AssignDate)>30 and ControlerID=$EXEID and Discription not like '%AMC%'and orders.EmployeeCode=$EmployeeID and AttendDate>='2022-01-01'";
                 $result3 = mysqli_query($con, $query3);
                 $row3 = mysqli_fetch_array($result3);
                 $AO=$row3["count(OrderID)"];
