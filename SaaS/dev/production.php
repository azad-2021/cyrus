      ...
      <form method="POST" action="">
        ...
        <center>
          <div class="form-group col-md-3">
            <input type="text" id="input" class="form-control my-select" placeholder="search number">
            <select class="form-control my-select" name="SimID" id="phone" required>
          ...
          <div class="form-group col-md-3" align="center">
            ...
            <input type="date" name="Date" class="form-control my-select" required>
          </div>
        </center>
