...
if (!empty($Data)){
  ...
  <div class="col-lg-12" style="margin: 12px;">
   <table class="container table table-hover table-bordered border-primary table-responsive">
    ...
    <tbody>
     <?php 
     $query2="SELECT * FROM cyrusbackend.demandextended 
     join cyrusbilling.rates on demandextended.RateID=rates.RateID
     join cyrusbackend.item on cyrusbilling.rates.ItemID=item.ItemID WHERE OrderID=$OrderID and demandextended.ItemQty !=0";
