                    ...
                    <tbody >
                      ...
                      while($row = mysqli_fetch_array($result)){
                        ...
                        <tr>
                          ...
                          <td><span class="d-none"><?php echo $row["DateOfInformation"]; ?></span><?php echo date('d-M-Y',strtotime($row["DateOfInformation"])); ?></td> 

                          <td><span class="d-none"><?php echo $row["DemandGenDate"]; ?></span><?php echo date('d-M-Y',strtotime($row["DemandGenDate"])); ?></td>
