          ...
          <div class="card-body">
            ...
            <div class="table-responsive container">
              <table width="100%" class="table display text-start align-middle table-bordered border-primary table-hover mb-0">
                ...
                <tbody>
                 <?php 
                 $query="SELECT `Employee Name`, employees.EmployeeCode FROM cyrusbackend.employees    group by employees.EmployeeCode order by `Employee Name`;";
                 ...
                 while($rowE=mysqli_fetch_assoc($resultTech)){
                  ...
                  $query="SELECT count(ComplaintID) FROM cyrusbackend.vallcomplaintsd 
                  ...
                  WHERE vallordersd.AssignDate is null and vallordersd.Discription like '%AMC%' and vallordersd.EmployeeCode=$EmployeeID";
                  $result2=mysqli_query($con,$query2);
                  $row2 = mysqli_fetch_array($result2);

                  $query3 = "SELECT count(vallordersd.OrderID) FROM vallordersd
                  WHERE AssignDate is null and Discription not like '%AMC%' and vallordersd.EmployeeCode=$EmployeeID";
          ...
          <div class="card-body">
            ...
            <div class="table-responsive container">
              ...
              <tbody >
                ...
                $query="SELECT * FROM cyrusbackend.branchdetails Group by BankName, ZoneRegionName;";
                ...
                while($rowB=mysqli_fetch_assoc($resultB)){
                  ...
                  where AssignDate is null and Attended=0 and BankName='$BankName' and ZoneRegionName='$ZoneRegionName'";
                  $result=mysqli_query($con,$query);
                  $row = mysqli_fetch_array($result);

                  $query2="SELECT count(DISTINCT vallordersd.OrderID) , BankName, ZoneRegionName FROM vallordersd
                  WHERE vallordersd.AssignDate is null and vallordersd.Discription like '%AMC%' and BankName='$BankName' and ZoneRegionName='$ZoneRegionName'";
                  $result2=mysqli_query($con,$query2);
                  $row2 = mysqli_fetch_array($result2);

                  $query3 = "SELECT count(DISTINCT vallordersd.OrderID) AS CountOfOrderID, BankName, ZoneRegionName FROM vallordersd
                  WHERE vallordersd.AssignDate is null and vallordersd.Discription not like '%AMC%' and BankName='$BankName' and ZoneRegionName='$ZoneRegionName'";
                  $result3 = mysqli_query($con, $query3);
                  $row3 = mysqli_fetch_array($result3);
