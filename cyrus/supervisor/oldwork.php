            ...
            <table class="table display text-start align-middle table-bordered border-primary table-hover mb-0">
              <thead>
                <tr class="text-dark">
                  ...
                  <th scope="col" style="min-width:150px">Work Type</th>
                  <th scope="col" style="min-width:150px">ID</th>
                  <th scope="col" style="min-width:150px">Visit Date</th>
                  <th scope="col" style="min-width:150px">Pending Work</th>
                </tr>
              </thead>
              <tbody>
               <?php 
               ...
               WHERE jobcardmain.VisitDate>='2022-01-01' and WorkPending is not null and length(WorkPending)>1 and ControlerID=$EXEID";
