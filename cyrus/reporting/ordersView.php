...
if (!empty($EmployeeID))
{
    ...
    $Ref='<button class="btn btn-primary gen" data-bs-toggle="modal" data-bs-target="#Reference" id="'.$row["OrderID"].'" id2="Order">Close ID</button>';
}else{
    $Ref='';
}
if (!empty($GadgetID))
...
if ($Attended=='No') {
    ...
    <tr>  
    <td width="30%"><label style="color:blue;" data-bs-toggle="modal" data-bs-discription="'.$row["Discription"].'" data-bs-OrderID="'.$row["OrderID"].'" data-bs-BranchCode="'.$row["BranchCode"].'" data-bs-target="#DiscriptionUpdate">Discription</label></td>  
    ...
    <tr>  
    <td width="30%"><label style="color:blue;" data-bs-toggle="modal" data-bs-received="'.$row["ReceivedBy"].'" data-bs-OrderID3="'.$row["OrderID"].'" data-bs-BranchCode3="'.$row["BranchCode"].'" data-bs-target="#ReceivedByUpdate">ReceivedBy</label></td>  
    <td width="70%">'.$row["ReceivedBy"].'</td>  
    </tr>
    <tr>  
    <td width="30%"><label style="color:blue;" data-bs-toggle="modal" data-bs-orderby="'.$row["OrderedBy"].'" data-bs-odid="'.$row["OrderID"].'" data-bs-Brcd="'.$row["BranchCode"].'" data-bs-target="#OrderByUpdate">Ordered By</label></td>  
    ...
    <tr>  
    <td width="30%"><label style="color:blue;" data-bs-toggle="modal" data-bs-gadget="'.$row["GadgetID"].'" data-bs-OrderID5="'.$row["OrderID"].'" data-bs-BranchCode5="'.$row["BranchCode"].'" data-bs-target="#gadgetUpdate">Gadget</label></td>  
