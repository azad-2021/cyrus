          ...
          <form method="POST" action="">
            <div class="form-row">
              ...
              <div class="form-group col-md-3">
               ...
               <select class="form-control my-select3" name="GadgetID" required onchange="yesnoCheck(this);">
            ...
            <div class="form-group col-md-12" id="1"  style="display: none;">
              ...
              <div class="form-group col-md-3">
                ...
                <select class="form-control my-select3" name="categoryZ2M1">
                  <option value="">Select</option>
              ...
              <div class="form-group col-md-3">
                ...
                <select class="form-control my-select3" name="categoryZ2M2">
                  <option value="">Select</option>
                  <option value="Alarm">Alarm</option>
                  <option value="Fire Alarm">Fire Alarm</option>
                </select>
            ...
            <div class="form-group col-md-12" id="2"  style="display: none;">
              ...
              <div class="form-group col-lg-2">
                ...
                <select class="form-control my-select3" name="categoryZ4M1">
                  <option value="">Select</option>
                  <option value="Alarm">Alarm</option>
                  <option value="Fire Alarm">Fire Alarm</option>
                </select>
              ...
              <div class="form-group col-md-2">
                ...
                <select class="form-control my-select3" name="categoryZ4M2">
                  <option value="">Select</option>
                  <option value="Alarm">Alarm</option>
                  <option value="Fire Alarm">Fire Alarm</option>
                </select>
              ...
              <div class="form-group col-md-2">
                ...
                <select class="form-control my-select3" name="categoryZ4M3">
                  <option value="">Select</option>
                  <option value="Alarm">Alarm</option>
                  <option value="Fire Alarm">Fire Alarm</option>
                </select>
              ...
              <div class="form-group col-md-3">
                ...
                <select class="form-control my-select3" name="categoryZ4M4">
                  <option value="">Select</option>
                  <option value="Alarm">Alarm</option>
                  <option value="Fire Alarm">Fire Alarm</option>
                </select>
