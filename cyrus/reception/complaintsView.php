...
if(isset($_POST["ComplaintID"]))
{
    ...
    //$date = str_replace('-"', '/', $row["DateOfInformation"]);  
       ...
       if (!empty($EmployeeID))
       {
        ...
        $Ref='<button class="btn btn-primary gen" data-bs-toggle="modal" data-bs-target="#Reference" id="'.$row["ComplaintID"].'" id2="Complaint">Generate Reference ID</button>';
...
if ($Attended=='No') {
    ...
    <tr>  
    <td width="30%"><label style="color:blue;" data-bs-toggle="modal" data-bs-discriptionC="'.$row["Discription"].'" data-bs-ComplaintID="'.$row["ComplaintID"].'" data-bs-BranchCodeC="'.$row["BranchCode"].'" data-bs-target="#DiscriptionUpdateC">Discription</label></td>  
    <td width="70%">'.$row["Discription"].'</td>  
    </tr>
    <tr>  
    <td width="30%"><label style="color:blue;" data-bs-toggle="modal" data-bs-InfoC="'.$row["DateOfInformation"].'" data-bs-ComplaintID2="'.$row["ComplaintID"].'" data-bs-BranchCodeC2="'.$row["BranchCode"].'" data-bs-target="#InfoDateUpdateC">Date Of Information</label></td>  
    <td width="70%">'.$InfoDate.'</td>  
    </tr>
    <tr>  
    <td width="30%"><label style="color:blue;" class="expC" data-bs-toggle="modal" expdateC="'.$row["ExpectedCompletion"].'" cid="'.$row["ComplaintID"].'" bccC="'.$row["BranchCode"].'" data-bs-target="#ExpDateUpdateC">Expected Completion</label></td>  
    <td width="70%">'.date("d-m-Y", strtotime($row["ExpectedCompletion"])).'</td>  
    </tr>
    <tr>  
    <td width="30%"><label style="color:blue;" data-bs-toggle="modal" data-bs-receivedC="'.$row["ReceivedBY"].'" data-bs-ComplaintID3="'.$row["ComplaintID"].'" data-bs-BranchCodeC3="'.$row["BranchCode"].'" data-bs-target="#ReceivedByUpdateC">ReceivedBy</label></td>  
    <td width="70%">'.$row["ReceivedBY"].'</td>  
    </tr>
    <tr>  
    <td width="30%"><label style="color:blue;" data-bs-toggle="modal" data-bs-madebyC="'.$row["MadeBy"].'" data-bs-ComplaintID4="'.$row["ComplaintID"].'" data-bs-BranchCodeC4="'.$row["BranchCode"].'" data-bs-target="#MadeByUpdateC">Made By</label></td>  
    ...
    <tr>  
    <td width="30%"><label style="color:blue;" data-bs-toggle="modal" data-bs-gadgetC="'.$row["MadeBy"].'" data-bs-ComplaintID5="'.$row["ComplaintID"].'" data-bs-BranchCodeC5="'.$row["BranchCode"].'" data-bs-target="#gadgetUpdateC">Gadget</label></td>  
