        ...
        <div class="card recent-sales overflow-auto">
          ...
          <div class="card-body">
            ...
            <div class="table-responsive container">
              <table class="table display text-start align-middle table-bordered border-primary table-hover mb-0" width="100%">
                <thead>
                  <tr class="text-dark">
  ...
  $(document).on('click', '.add', function(){
    ...
    if (ZoneCode) {
      ...
      $.ajax({
        type:'POST',
        url:'material.php',
        data:{'ZoneCode':ZoneCode, 'OrderID':OrderID},
