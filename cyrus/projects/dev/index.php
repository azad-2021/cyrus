          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-4">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Total <span>| Pending Payment</span><br></h5>

                  <div class="d-flex align-items-center">
                    <div class="ps-3">
                      <h6>&#x20B9 <?php echo number_format($PendingPayment,2).'&nbsp; &nbsp; '; ?></h6>
                    </div>
                  </div>
                </div>
            ...
            <div class="card-body">
              ...
              <div class="table-responsive container">
                <table class="table text-start align-middle table-bordered table-hover mb-0">
                  <thead>
                    <tr class="text-dark">
                      <th scope="col" style="min-width:200px">Organization</th>
                      <th scope="col" style="min-width:200px">Zone/Division</th>
                      <th scope="col" style="min-width:200px">site</th>
