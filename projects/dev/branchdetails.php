    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Branch/Site Details</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="col-md-12">
        ...
        <form class="needs-validation form-control novalidate rounded-corner" method="POST" style="margin-bottom: 5px;">
          <div class="row g-3">
            ...
            <div class="col-sm-4">
              <select id="BankP" class="form-control rounded-corner" name="BankP" required>
            ...
            <div class="col-sm-4">
              <select id="ZoneP" class="form-control rounded-corner" name="ZoneP" required>
                <option value="">Zone/Division</option>
              </select>
            </div>
            <div class="col-sm-4">
              <select id="BranchP" class="form-control rounded-corner" name="BranchP" required>
                <option value="">Branch/Site</option>
              </select>
            </div>
          </div>
        </form>
...
<script type="text/javascript">
 ...
 $(document).on('change','#BankP', function(){
  ...
  if(BankCode){
    ...
    $('#ZoneP').html('<option value="">Zone/Division</option>');
    $('#BranchP').html('<option value="">Branch/Site</option>'); 
  }
});
 ...
 $(document).on('change','#ZoneP', function(){
 ...
 $(document).on('change','#BranchP', function(){
