      ...
      <div class="col-lg-12">
        ...
        <div class="table-responsive container">
          <table width="100%" class="table display text-start align-middle table-bordered border-primary table-hover mb-0">
            ...
            <tbody >
              <?php 
              $query="SELECT distinct approval.OrderID, ZoneRegionName, BranchName, Address3, Discription, DateOfInformation, AssignDate, VDate, Vremark FROM cyrusbackend.approval
