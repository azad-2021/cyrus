...
if(isset($_POST['Addtech']))
{
  ...
  if(empty(mysqli_fetch_assoc($result))==false){
    ...
    $queryAddtech="INSERT INTO `add_technician` (`EmployeeUID`, `TechnicianID`, `TechnicianName`, `TechnicianContact`) VALUES ('$EmployeeID', '$Employee', '$TechnicianName', $TechnicianContact);";

    if ($con2->query($queryAddtech) === TRUE) {
      echo "<meta http-equiv='refresh' content='0'>";
    } else {
      echo "Error: " . $queryAddtech . "<br>" . $con2->error;
    }
  }
}
